...
The use of validators displays a security mindset that prioritizes solid and trusted frameworks over potentially bug-riden custom implementations. Some files were also cleaned up and
unused CSS files were deleted to pull from one main css style.
